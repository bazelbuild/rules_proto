...
load("//proto/private:dependencies.bzl", "maven_dependencies", "prebuilt_binaries", "protobuf_workspace", "transitive_dependencies")
...
def rules_proto_dependencies():
    ...
    for name in transitive_dependencies:
        maybe(http_archive, name, **transitive_dependencies[name])
